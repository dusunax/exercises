!(function (e, t) {
          ...
          : (e < 2048
              ...
              : (55296 == (64512 & e) &&
                ...
                56320 == (64512 & t.charCodeAt(i + 1))
                  ? ((e =
                      65536 + ((1023 & e) << 10) + (1023 & t.charCodeAt(++i))),
                    (r[n++] = (e >> 18) | 240),
                    (r[n++] = ((e >> 12) & 63) | 128))
                  : (r[n++] = (e >> 12) | 224),
                (r[n++] = ((e >> 6) & 63) | 128)),
    ...
    n = {
      ...
      encodeByteArray(r, e) {
        ...
        for (let h = 0; h < r.length; h += 3) {
          ...
          let e = ((15 & o) << 2) | (l >> 6),
            t = 63 & l;
          c || ((t = 64), s || (e = 64)),
            i.push(n[a >> 2], n[((3 & a) << 4) | (o >> 4)], n[e], n[t]);
        }
        return i.join("");
      },
      encodeString(e, t) {
          ...
          : (function (e) {
              ...
              for (; r < e.length; ) {
                ...
                s < 128
                  ...
                  : 191 < s && s < 224
                  ? ((i = e[r++]),
                    (t[n++] = String.fromCharCode(((31 & s) << 6) | (63 & i))))
                  : 239 < s && s < 365
                  ? ((a =
                      (((7 & s) << 18) |
                        ((63 & e[r++]) << 12) |
      ...
      decodeStringToByteArray(e, t) {
        ...
        for (let c = 0; c < e.length; ) {
          ...
          if ((++c, null == i || null == a || null == s || null == o))
            throw new l();
          n.push((i << 2) | (a >> 4)),
            64 !== s &&
              (n.push(((a << 4) & 240) | (s >> 2)),
  ...
  const e = () =>
    ...
    h = () => {
      var e;
      return null === (e = a()) || void 0 === e ? void 0 : e.config;
    };
  class s {
    constructor() {
      (this.reject = () => {}),
  ...
  class w {
    ...
    onInit(e, t) {
      ...
      const n =
        null !== (i = this.onInitCallbacks.get(r)) && void 0 !== i
          ? i
          : new Set();
    ...
    getOrInitializeService({ instanceIdentifier: e, options: t = {} }) {
      ...
      if (
        ...
        ((r = this.component.instanceFactory(this.container, {
          instanceIdentifier: (n = e) === y ? void 0 : n,
          options: t,
        })),
  ...
  function x(n) {
    return n !== IDBDatabase.prototype.transaction ||
      ...
      ? (M = M || [
        ...
        ? function (...e) {
            return n.apply(W(this), e), U(k.get(this));
          }
        : function (...e) {
            return U(n.apply(W(this), e));
          }
      : function (e, ...t) {
          var r = n.call(W(this), e, ...t);
          return j.set(r, e.sort ? e.sort() : [e]), U(r);
        };
  }
  function V(e) {
    ...
    if (e instanceof IDBRequest)
      return (function (a) {
        ...
        return (
          e
            .then((e) => {
              e instanceof IDBCursor && k.set(e, a);
            })
            .catch(() => {}),
          z.set(e, a),
          e
  ...
  function Y(e, t) {
    if (e instanceof IDBDatabase && !(t in e) && "string" == typeof t) {
      ...
      const i = t.replace(/FromIndex$/, ""),
        ...
        s = G.includes(i);
      if (
        i in (a ? IDBIndex : IDBObjectStore).prototype &&
        (s || J.includes(i))
      ) {
        var r = async function (e, ...t) {
          ...
          return (
            a && (n = n.index(t.shift())),
            (await Promise.all([n[i](...t), s && r.done]))[0]
          );
        };
        return K.set(t, r), r;
      }
  ...
  class pe extends ue {
    constructor(e, t, r, n) {
      var i =
          ...
          t.automaticDataCollectionEnabled,
        a = { name: r, automaticDataCollectionEnabled: i };
      void 0 !== e.apiKey ? super(e, a, n) : super(e.options, a, n),
    ...
    incRefCount(e) {
      this.isDeleted ||
        (this._refCount++,
        void 0 !== e && this._finalizationRegistry.register(e, this));
    }
    decRefCount() {
  ...
  function ge(e, t = {}) {
    ...
    var n = Object.assign({ name: te, automaticDataCollectionEnabled: !1 }, t);
    const i = n.name;
    if ("string" != typeof i || !i)
      throw de.create("bad-app-name", { appName: String(i) });
    if (((r = r || h()), !r)) throw de.create("no-options");
    var a = ne.get(i);
    if (a) {
      if (g(r, a.options) && g(n, a.config)) return a;
      throw de.create("duplicate-app", { appName: i });
    }
    const s = new C(i);
  ...
  function me(e, t, r) {
    ...
    ce(new E(`${n}-version`, () => ({ library: n, version: t }), "VERSION"));
  }
  function ve(e, t) {
    if (null !== e && "function" != typeof e)
      throw de.create("invalid-log-argument");
    !(function (a, e) {
      for (const t of D) {
        let i = null;
        e && e.level && (i = A[e.level]),
          (t.userLogHandler =
            null === a
              ? null
              : (e, t, ...r) => {
  ...
  const Ee = "firebase-heartbeat-database",
    ye = 1,
          ...
          return (
            n &&
              s.addEventListener("upgradeneeded", (e) => {
                n(U(s.result), e.oldVersion, e.newVersion, U(s.transaction), e);
              }),
            r &&
  ...
  class Oe {
    ...
    async triggerHeartbeat() {
      var e;
      const t = this.container.getProvider("platform-logger").getImmediate();
      var r = t.getPlatformInfoString();
      const n = Ae();
      if (
        (null !=
      ...
      if (
        ...
        null ==
          (null === (r = this._heartbeatsCache) || void 0 === r
            ? void 0
            : r.heartbeats) || 0 === this._heartbeatsCache.heartbeats.length)
      )
        return "";
      var e = Ae(),
        { heartbeatsToSend: t, unsentEntries: r } = (function (e, t = 1024) {
          ...
          for (const i of e) {
            ...
            if (a) {
              ...
              (r.push({ agent: i.agent, dates: [i.date] }), Ne(r) > t)
            ) {
              r.pop();
              break;
            }
        ...
        t = i(JSON.stringify({ version: 2, heartbeats: t }));
      return (
  ...
  (ee = ""),
    ce(new E("platform-logger", (e) => new X(e), "PRIVATE")),
    ce(new E("heartbeat", (e) => new Oe(e), "PRIVATE")),
    me(q, Z, ee),
    me(q, Z, "esm2017"),
    me("fire-js", "");
  var Be = Object.freeze({
    ...
    initializeServerApp: function (e, t) {
      if (d()) throw de.create("invalid-server-app-environment");
      void 0 === t.automaticDataCollectionEnabled &&
      ...
      if (
        ...
        throw de.create("finalization-registry-not-supported", {});
      var i =
        "" +
  ...
  class Te {
    constructor(e, t) {
      (this._delegate = e),
        (this.firebase = t),
        se(e, new E("app-compat", () => this, "PUBLIC")),
    ...
    delete() {
      return new Promise((e) => {
        ...
        () => (this.firebase.INTERNAL.removeApp(this.name), be(this._delegate))
      );
    }
    _getService(e, t = te) {
      var r;
  ...
  function Pe(i) {
              ...
              ce(r) &&
                ...
                ((e = (e = o()) => {
                  if ("function" != typeof e[t])
                    throw Re.create("invalid-app-argument", { appName: n });
                  return e[t]();
                }),
    ...
    function o(e) {
      if (((e = e || te), !f(a, e))) throw Re.create("no-app", { appName: e });
      return a[e];
    }
    return (
      (s.default = s),
  ...
  const ke = new T("@firebase/app-compat");
  if (d() && void 0 !== self.firebase) {
    ke.warn(`
  ...
  const Fe = Me;
  me("@firebase/app-compat", "0.2.33", void 0);
  return Fe.registerVersion("firebase", "10.12.0", "app-compat-cdn"), Fe;
});
